        ...
        <section className=' z-50 glass p-4 flex top-0 left-0 w-full h-14 sticky bg-slate-100 border-b-2 border-b-slate-400 justify-between items-center md:px-4 px-2'>
            ...
            <div className='flex justify-end'>
                ...
                <input onClick={() => {toast.error('oops... a quanto pare questa funzione non é ancora stata sviluppata! :((', {
                 ...
                 className=' w-full max-w-[40vw] md:px-4 px-[4px] md:py-2 py-2 text-xs md:text-base rounded-lg border border-slate-300 focus:outline-none focus:border-violet-500' />
            </div>
                </div>
